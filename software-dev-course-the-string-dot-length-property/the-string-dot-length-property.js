...
// Your code here
// Calculate the length of stringOne and assign it to lengthOne
lengthOne = stringOne.length;

// Calculate the length of stringTwo and assign it to lengthTwo
lengthTwo = stringTwo.length;

// Calculate the length of stringThree (an empty string) and assign it to lengthThree
lengthThree = stringThree.length;

// You can add console.log statements here to verify the results
console.log(`Length of "${stringOne}": ${lengthOne}`);     // Expected: 15
